...
{
    /* All Credits goes to DexModderFTW, Shark, John_dat_goon and makeabce*/
    class RPC
    {
        private static UInt32 function_address = 0x6E34E0; //MP = 0x7A21E0  ||  ZM = 0x6E34E0
        ...
        {
            Call(0x003C33A8, client, 1, command);
        }

        public static void Cbuff_AddText(int localClient, string text)
        {
            Call(0x00395BA8, localClient, text);
        }
    }
}
